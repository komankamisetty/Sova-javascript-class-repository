...
let day = prompt("WHat day of the week is this?").toLowerCase(); // keep as string, and make it lowercase so it matches
if (day === "monday") {
    console.log("It's the start of the week!");  
} else if (day === "friday") { // these run sequencially
    console.log("It's almost the weekend!");
} else if (day === "saturday" || day === "sunday") {  //the double vertical slashes (||) are as an or for this
